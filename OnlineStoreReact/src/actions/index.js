...
const CATEGORIES_CRUD_URL = "/api/admin/categories";
...
export function fetchCategories() {
    ...
    const request = axios.get(API_URL + CATEGORIES_URL);
    return {
...
export function categoryDetail(categoryId) {
    const request = axios.get(API_URL + CATEGORIES_URL + "/" + categoryId);
    return {
...
export function addCategory(props) {
    ...
    var request = axios.post(API_URL + CATEGORIES_CRUD_URL, props, {
        'headers': {
...
export function updateCategory(props) {
    ...
    var request = axios.put(API_URL + CATEGORIES_CRUD_URL, props, {
        'headers': {
            "Authorization": "Bearer " + token.accessToken
        }
    }).catch((error) => {
...
export function deleteCategory(id) {
    ...
    var request = axios.delete(API_URL + CATEGORIES_CRUD_URL + "/" + id, {
        'headers': {
            "Authorization": "Bearer " + token.accessToken
        }
    }).catch((error) => {
...
export function fetchProducts(categoryId, page) {
    const request = axios.get(API_URL + PRODUCTS_URL + "/" + categoryId + "/" + page);
    return {
...
export function productDetail(productId) {
    const request = axios.get(API_URL + PRODUCTS_URL + "/" + productId)
    //console.log(request);
    return {
        type: PRODUCT_DETAIL,
        payload: request
